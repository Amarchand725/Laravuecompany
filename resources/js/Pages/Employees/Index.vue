...
const openModal = (op,name,email,phone,department,employee)=>{
    console.log(name+'--'+email+'--'+phone+'--'+department+'--'+employee);
    modal.value = true;
                ...
                <table class="table-auto border border-gray-400">
                    ...
                    <tbody>
                        <tr v-for="emp, i in employees.data" :key="emp.id">
                            <td class="border border-gray-400 mx-2 py-2">{{ (i+1) }}.</td>
                            <td class="border border-gray-400 mx-2 py-2">{{ emp.name }}</td>
                            <td class="border border-gray-400 mx-2 py-2">{{ emp.email }}</td>
                            <td class="border border-gray-400 mx-2 py-2">{{ emp.phone }}</td>
                            <td class="border border-gray-400 mx-2 py-2">{{ emp.department }}</td>
                            <td class="border border-gray-400 mx-2 py-2">
